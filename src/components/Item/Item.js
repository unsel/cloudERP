  ...
  useEffect(()=>{
    ...
    return (
        <div className={classes.Item}>
            ...
            <p className={classes.Name}> <strong>{props.itemName}</strong></p> 
            <p className={classes.Others}> <strong><FontAwesomeIcon icon="circle" color='#5e64ff' size='xs'/>&nbsp;{props.status}</strong></p>
            <p className={classes.Workers}> <strong>{props.itemCode}</strong></p>
            <p className={classes.Others}> <strong>{props.itemGroup}</strong></p>
            {/* <p className={classes.Others}> <strong>{props.unit}</strong></p> */}
